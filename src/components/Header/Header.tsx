        ...
        type !== 'null' && (
          <HeaderContainer type={type} isMobile={isMobile} hasSubtitle={!!subtitle}>
            ...
            <TitleContainer>
              ...
              {type === 'tertiary' && <Link to="http://www.virufy.org" target="_blank"><LogoImg srcSet={`${Logo}, ${Logo2x} 2x, ${Logo3x} 3x`} src={LogoImg} size={location.pathname !== '/elderlycare/welcome' ? 'regular' : 'big'} /></Link>}
            </TitleContainer>
          </HeaderContainer>
        )
      }
